...
%http://stackoverflow.com/questions/1261426/multiple-commands-in-an-environment-in-latex
...
\begin{itemize}[leftmargin=-0.5em, label={}]
	...
	\begin{itemize}
		...
		\item Fixed a registry key related bug in the company's agent using \CPP.
		\item Lots of experience setting up and troubleshooting a Hadoop/HBase/Spark installation.
	...
	\begin{itemize}
		...
		\item Created a variety of MySQL dump scripts in Python and SQL that are run daily using cron.
