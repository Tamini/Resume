...
\runsubsection{AMD}
\descript{| Kernel Mode Driver Developer}

\location{January 2016 - April 2016 | Markham, ON}
\vspace{\topsep}
\begin{tightitemize}
\item Fixed bugs in the AMD Kernel Mode Driver for Windows 7, 8.1 and 10.
\item Led the team that created a \CPP program to simulate attacks on the AMD display driver.  Fixed all identified security vulnerabilities leading to a more secure and reliable driver for AMD's users.
\end{tightitemize}
