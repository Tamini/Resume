...
Creating a third-person PC game in Unreal Engine 4 using Blueprints and C++.  Currently have enemy NPCs, basic animations and basic combat.  Will require working with game AI, animating, modelling, texturing and programming.  Working with Blender for modelling and Maya for animation.

\sectionspace % Some whitespace after the section

%------------------------------------------------

\runsubsection{Markov Chain}
